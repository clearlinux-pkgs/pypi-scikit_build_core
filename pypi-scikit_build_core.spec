...
Source0  : https://files.pythonhosted.org/packages/06/c7/46b4becf16d6164f46f26cfd3c8b192a994b2a90bd731df1974b788fb391/scikit_build_core-0.9.8.tar.gz
...
%prep
%setup -q -n scikit_build_core-0.9.8
cd %{_builddir}/scikit_build_core-0.9.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719849592
